...
import { DatabaseSchemaViewer } from '@/components/admin/models/database-schema-viewer';
import { PostTypeSchemaViewer } from '@/components/admin/models/post-type-schema-viewer';
