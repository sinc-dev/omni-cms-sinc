-- ============================================================================
-- FIX: Attach Custom Fields to Post Types (For ALL Organizations)
-- 
...
-- ============================================================================
-- Run this BEFORE Step 2 to verify there are no custom fields from wrong organizations
...
-- ============================================================================
-- STEP 2: Fix ALL Organizations - Attach Fields to ALL Post Types
-- ============================================================================
-- This single query fixes all organizations and all post types at once
-- It finds all custom fields that have values and attaches them
-- INCLUDES SAFETY CHECK to ensure custom fields belong to same organization
...
WHERE o_post.slug IN ('study-in-kazakhstan', 'study-in-north-cyprus', 'paris-american-international-university')
  ...
  -- This prevents cross-organizational field attachments
...
-- ============================================================================
-- STEP 3.5: Verify Organizational Isolation (Post-Fix Check)
-- ============================================================================
...
-- If wrong_org_fields > 0, there's a cross-organizational issue that needs fixing

-- ============================================================================
-- STEP 4: See What Fields Were Attached (Summary by Organization)
-- ============================================================================
...
-- ============================================================================
-- ALTERNATIVE: Fix One Organization at a Time
-- ============================================================================
-- If you prefer to fix organizations one at a time, use these queries
-- Replace 'study-in-kazakhstan' with the organization slug
...
WHERE o_post.slug = 'study-in-kazakhstan'
  AND o_post.id = o_field.id  -- Safety check: same organization
  AND NOT EXISTS (
...
-- org_check should always show '✅ CORRECT' - if you see '❌ WRONG ORG', there's a problem
