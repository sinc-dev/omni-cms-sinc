...
import { FieldList } from '@/components/admin/post-types/field-list';
import { FieldAttachmentDialog } from '@/components/admin/post-types/field-attachment-dialog';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" asChild>
          <Link href={`/admin/post-types/${postTypeId}/edit`}>
